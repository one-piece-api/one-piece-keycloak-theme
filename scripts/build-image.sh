#!/usr/bin/env bash
# Builda l'immagine Docker usando il Dockerfile alla radice del repo. Nessun
# push: l'immagine resta solo nel Docker daemon locale, pronta per
# "kind load docker-image" (vedi
# onepiece-infrastructure/scripts/build-and-load-local-image.sh).
...
IMAGE_NAME="one-piece-keycloak-theme"
